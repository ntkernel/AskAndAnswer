...
public class MyAskFragment extends BaseFragment implements FootView {
    ...
    private Handler mHander = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case 9:
                    ((UserPresenter) mPresenter).getMyAsk(mType, limit, currentPage,9);
                    break;
            }
        }
    };
    ...
    private void initView() {
        ...
        baseSectionQuickAdapter = new BaseSectionQuickAdapter<MyFootSection,BaseViewHolder>(R.layout.item_more_know, R.layout.item_section_header, mySectionList) {
            ...
            protected void convert(BaseViewHolder helper, MyFootSection item) {
                ...
                if(mType == 0){
                    helper.getView(R.id.mTeaTv).setVisibility(View.GONE);
                    helper.getView(R.id.mTeaLeavlTv).setVisibility(View.GONE);
                    helper.getView(R.id.mTeaSchoolTv).setVisibility(View.GONE);
                    helper.getView(R.id.mContentTv).setVisibility(View.GONE);
                    helper.getView(R.id.mTeaCiv).setVisibility(View.GONE);
                }
