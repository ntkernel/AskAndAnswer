...
import com.ruiyi.askandanswer.user.fragment.MyCollectFragment;
...
public class MyCollectActivity extends BaseActivity implements AskMoreView {
    ...
    private void initView() {
        ...
        mPresenter = new AskMorePresenter(MyCollectActivity.this,mHander);
    ...
    public void onSubjectsResult(List<SubjectData> subjectDataList) {
        for (SubjectData item : subjectDataList) {
            ...
            MyCollectFragment fragmenet = new MyCollectFragment();
