...
import com.ruiyi.askandanswer.ask.fragment.AskMoreFragment;
...
public class AskMoreActivity extends BaseActivity implements AskMoreView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_askmore);
    ...
    private void initView() {
        ...
        mHeaderBar.setRightVisiable(true);
        mHeaderBar.getRightView().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ToolUtils.startActivity(AskMoreActivity.this,SearchActivity.class,null);
            }
        });

        mPresenter = new AskMorePresenter(AskMoreActivity.this,mHander);
    ...
    public void onSubjectsResult(List<SubjectData> subjectDataList) {
        for (SubjectData item : subjectDataList) {
            ...
            AskMoreFragment fragmenet = new AskMoreFragment();
        ...
        CommonNavigator commonNavigator = new CommonNavigator(AskMoreActivity.this);
